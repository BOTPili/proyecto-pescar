const cuestions = [
    {
        ...
        'pregunta': 'Tengo dificultades para crear una cuenta gmail, dice existente',
        'cantRespuestas': '6',
        'categoria': 'Adultos',
    ...
    {
        'resuelto': false ,
        'nombreUsuario': 'Alberto_Moyano',
        'imagenUsuario': 'https://cdn.icon-icons.com/icons2/1141/PNG/512/1486395884-account_80606.png',
        'pregunta': 'Me podrían ayudar a realizar mi CV como me enseñaron acá pero en inglés?',
        'cantRespuestas': '3',
        'categoria': 'Adultos',
    ...
    {
        'resuelto': true ,
        'nombreUsuario': 'Elisa_Rodriguez',
        'imagenUsuario': 'https://cdn.icon-icons.com/icons2/1141/PNG/512/1486395884-account_80606.png',
        'pregunta': 'Ya descargué facebook gracias al video, cual es el siguiente?',
        'cantRespuestas': '2',
    ...
    {
        'resuelto': false ,
        'nombreUsuario': 'jose_j',
        'imagenUsuario': 'https://cdn.icon-icons.com/icons2/1141/PNG/512/1486395884-account_80606.png',
        'pregunta': 'Me fue bien en la prueba gracias al video de resumenes, hay más formas de estudiar?',
        'cantRespuestas': '12',
