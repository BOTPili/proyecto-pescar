            ...
            <div class="" >
                ...
                <div class="d-flex justify-content-around">
                    ...
                    <div class="d-flex flex-column mt-5">
                        ...
                        <div class="my-2" >
                            <a class="d-flex align-items-center nav-link"  href=""><i class="fa-brands fa-facebook"></i> /EducArteFB </a>
                        </div>
                        <div class="my-2" >
                            <a class="d-flex align-items-center nav-link"  href=""><i class="fa-brands fa-youtube"></i> /EducArteYT</a>
                        </div>
                        <div class="my-2" >
                            <a class="d-flex align-items-center nav-link"  href=""><i class="fa-brands fa-instagram"></i> /EducArteIG</a>
                        </div>
                        <div class="my-2" >
