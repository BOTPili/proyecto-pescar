...
<nav class="navbar navbar-expand-lg navbar-dark  static-top" style=" background: rgb(0,0,0);
  ...
  <div class="container-fluid">
    <div class="d-flex align-items-center">
      ...
      <a class="navbar" href="#">
        <img src="../images/logo-educarte.png" class="nav-image-project" alt="..." width="100">
      </a>
      <h2 class="nav-name-project">EDUCART</h2>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link text-end" <?php echo $pg=="inicio" ? "active" : "" ?> aria-current="page"
        ...
        <li class="nav-item">
          <a class="nav-link text-end" <?php echo $pg=="nosotros" ? "active" : "" ?> href="nosotros.php">Sobre
            nosotros</a>
        </li>
      </ul>
    </div>
