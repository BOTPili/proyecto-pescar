    ...
    <main class="foro-main">
        ...
        <section class="foro-continer-question-buttons">
            <div class="foro-container-buttons">
                ...
                <section class="foro-container-buttons-solutions"><a href="#">TODO</a><a href="#">SOLUCIONADO</a><a
                        href="#">NO RESUELTO</a>
                </section>
                <section class="foro-container-buttons-find-filters">
                    <div class="foro-container-find"><input type="search" class="foro-find"><svg
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-search" viewBox="0 0 16 16">
                            <path
                                d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                        </svg></div><a href="#">FILTROS</a>
                </section>
            </div>
            <section class="foro-container-question">
                <article class="foro-question">
                    ...
                    <section><h5>¿Como chucha se hace para tener lvl astral en linkedin? no entiendo alguien me explica.</h5>
                    <div><p>6 Respuestas</p></div>
                    <h6>Última actualización 15/06/2022 20:09hs</h6>
                </section>
                    <section><h3>CATEGORÍA</h3><div>
                        <h3>ADULTOS</h3>
                    </div></section>
                </article>
            </section>
