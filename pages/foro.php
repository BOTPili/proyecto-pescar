        ...
        <div class="foro-main">
            ...
            <section class="foro-continer-question-buttons">
                <div class="foro-container-buttons">
                    ...
                    <section class="foro-container-buttons-solutions"><a class="foro-buttons-solutions-all" href="#">TODO</a><a class="foro-buttons-solutions-all foro-solutions-resolve" href="#">SOLUCIONADO</a><a class="foro-buttons-solutions-all foro-solutions-resolve" href="#">NO RESUELTO</a>
                    </section>
                    <section class="foro-container-buttons-find-filters">
                        <div class="foro-container-find"><input placeholder="BUSCAR" type="search" class="foro-find"><svg class="foro-find-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
